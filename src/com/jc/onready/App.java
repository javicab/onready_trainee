package com.jc.onready;
	...
	public class App {
	    ...
	    public static void cargarListaVehiculos() {
	        ...
	        listaVehiculos.add(new Moto("Yamaha", "YBR", 160, 80500.50f));
	    ...
	    public static void main(String[] args) {
	        ...
	        Concesionaria concesionaria = new Concesionaria (App.listaVehiculos);
	        concesionaria.imprimirLista();

	        concesionaria.imprimirSeparacion();
	        System.out.println("Vehículo más caro: " + concesionaria.extraerMarcaModelo(concesionaria.buscarMayorPrecio()));
	        System.out.println("Vehículo más barato: " + concesionaria.extraerMarcaModelo(concesionaria.buscarMenorPrecio()));
	        System.out.println("Vehículo que contiene en el modelo la letra ‘Y’: " + concesionaria.extraerMarcaModeloPrecio(concesionaria.buscarLetraEnNombre("Y")));
	        
	        concesionaria.imprimirSeparacion();
	        System.out.println("Vehículos ordenados por precio de mayor a menor:");
	        List<Vehiculo> listaOrdenada = new ArrayList<Vehiculo>();
	        listaOrdenada = concesionaria.ordenarListaDeMayorAMenorPorPrecio(concesionaria.getListaVehiculos());
	        concesionaria.imprimirListaOrdenada(listaOrdenada);
